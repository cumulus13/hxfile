...
setup(
    ...
    license = 'MIT License',
    keywords = "unofficial HXFILE API (still maintenance, open contributor",
    url = 'https://github.com/cumulus13/hxfile',
    scripts = [],
    # py_modules = [NAME],
    packages = [NAME],
    download_url = 'https://github.com/cumulus13/hxfile/tarball/master',
    install_requires=['hxfile', 'api', 'unoffcial', 'link generator', 'generator', 'download', 'downloader', 'cloud', 'file manager', 'cli', 'command line'],
